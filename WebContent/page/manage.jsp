...
<div id="header" class="wrap">
	...
	<div class="search">
		欢迎你,${sessionScope.name.getName()}
		<label class="ui-green"><input onclick="toUrl('page/add.jsp');" type="button" name="search" value="发布房屋信息" /></label>	
		<label class="ui-green"><input type="button" name="search" value="退       出" onclick='document.location="login_struts2.jsp"'/></label>
	</div>
</div>
<div class="main wrap">
<s:div id="houseArea">
		...
		<tr>
			...
			<td>
				...
				<s:a href="%{show}"><s:property value="title"/></s:a>
					...
					<dd>
						<s:property value="streets.district.districtname"/>区
						<s:property value="streets.name"/>，
						<s:property value="floorage"/>平米<br/>
						联系方式:<s:property value="users.telePhone"/>
